...
namespace WebAPI.Controllers
{
        ...
        HomeController : Controller
    {
        ...
        public async Task<HttpStatusCodeResult> Register(string email, string password, string passwordConfirm)
        {
            ...
            var response = await CallApiTask("api/People/Register", registerModel);
        ...
        public async Task<ICollection<string>> GetValues()
        {
            if (_myToken != null)
            {
                using (var client = new HttpClient())
                {
                    ...
                    client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", _myToken.authToken);
